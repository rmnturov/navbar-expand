  ...
  return (
    ...
    >
      <div className="navbar-header">
        {/* Первая строка: кнопка grid-squares слева */}
      ...
      {/* Кнопка закрепить/развернуть внизу меню */}
          ...
          <div className="toggle-button-inner">
            <div className="toggle-icon-container">
              <KoobiqIcon 
                name="pin" 
                size={16} 
                className={`toggle-icon ${isPinned ? "hidden" : "visible"}`}
              />
              <KoobiqIcon 
                name="chevron-double-left" 
                size={16} 
                className={`toggle-icon ${isPinned ? "visible" : "hidden"}`}
              />
            </div>
            <span className="toggle-text">
              {isPinned ? "Свернуть" : "Закрепить"}
            </span>
          </div>
        </button>
      </div>
